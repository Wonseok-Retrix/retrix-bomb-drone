...
if ! sudo apt install -y python3-pymavlink; then
  echo "-- python3-pymavlink is unavailable from apt; installing with pip --"
  pip3 install --break-system-packages pymavlink
fi

echo "== 4/5 Serial port (flight controller connection) =="
